                    ...
                    <div class="col-lg-6 ">
                        <div class="form-group">
                            <div class="input-group w3_w3layouts col-lg-12">
                                ...
                                <input type="text" name="physician" class="form-control" placeholder="Physician" aria-describedby="basic-addon1" required="" / >
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 ">
                        <div class="form-group">
                            <div class="input-group w3_w3layouts col-lg-12">
                                ...
                                <input type="num" name="age" class="form-control" placeholder="Age" aria-describedby="basic-addon1" required=""/ >
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 ">
                        <div class="form-group">
                            <div class="input-group w3_w3layouts col-lg-12">
                                ...
                                <input type="text" name="diagnosis" class="form-control" placeholder="Diagnosis" aria-describedby="basic-addon1" required="" / >
                            </div>
                        </div>
                    </div>
