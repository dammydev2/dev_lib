     ...
     <!-- form ended-->
                     ...
                     <?php 
                      ...
                      if (isset($_POST['update'])) {
                       ...
                       $up = " UPDATE patient SET patientnum = '$patient', name = '$name', age = '$age', address = '$address', sex = '$sex', physician = '$physician', ward = '$clinic', diagnosis = '$diagnosis' WHERE patientnum = '$patient'";
